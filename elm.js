...
var $author$project$Main$defaultSize = 5;
...
var $author$project$Main$getQueryInt = F2(
	function (str, query) {
		return $elm$core$List$head(
			A2(
				$elm$core$List$filterMap,
				function (part) {
					var _v0 = A2($elm$core$String$split, '=', part);
...
var $author$project$Main$init = F3(
	function (navKey, url, _v0) {
		...
		return _Utils_Tuple2(initModel, cmd);
	});
	...
	function (_v0, s) {
		...
		return A2(
			...
			function (_v1) {
				var x_ = _v1.a;
				var y_ = _v1.b;
				return (x_ >= 0) && ((y_ >= 0) && ((_Utils_cmp(x_, s) < 0) && (_Utils_cmp(y_, s) < 0)));
			},
			_List_fromArray(
				[
...
var $author$project$Main$flagSurround = F3(
	function (_v0, s, dic) {
		var x = _v0.a;
		var y = _v0.b;
		var isAllOpened = $elm$core$Dict$isEmpty(
			A2(
				$elm$core$Dict$filter,
				F2(
					function (c, tile) {
...
var $author$project$Main$openSurround = F3(
	function (_v0, s, dic) {
		var x = _v0.a;
		var y = _v0.b;
		var isAllFlagged = $elm$core$Dict$isEmpty(
			A2(
				$elm$core$Dict$filter,
				F2(
					function (c, tile) {
...
var $author$project$Main$gameStatusView = function (model) {
	...
	switch (_v0.$) {
		...
		default:
			return _Utils_eq(model.flags, model.bombs) ? $elm$html$Html$text('Game Clear !!') : $elm$html$Html$text('Game Over !!');
	}
};
